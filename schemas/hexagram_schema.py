...
class HexagramSchema:
    def __init__(
        ...
        self.index = None
        self.url = None
        self.__prepare(lower_trigram, upper_trigram, schema_type)

        HexagramSchemaValidator(self.schema, self.index, self.schema_type)

    def __prepare(self, lower_trigram: Trigram, upper_trigram: Trigram, schema_type) -> None:
